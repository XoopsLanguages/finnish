...
//2.8.0
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES', 'Ota kielten hallinta käyttöön');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES_DESC', 'Hallitse maa-asetustorekisteriä, kielipaketteja, kuntotarkistuksia ja sivuston käännösten ohituksia.');
define('_MI_SYSTEM_BNAME14', 'Kielenvalitsin');
