...
define('MENUS_HOME', 'Etusivu');
define('MENUS_ADMIN', 'Hallinta');
define('MENUS_ACCOUNT', 'Tili');
define('MENUS_ACCOUNT_EDIT', 'Muokkaa tiliä');
define('MENUS_ACCOUNT_LOGIN', 'Kirjaudu sisään');
define('MENUS_ACCOUNT_LOGOUT', 'Kirjaudu ulos');
define('MENUS_ACCOUNT_REGISTER', 'Rekisteröidy');
define('MENUS_ACCOUNT_MESSAGES', 'Viestit');
define('MENUS_ACCOUNT_NOTIFICATIONS', 'Ilmoitukset');
define('MENUS_ACCOUNT_TOOLBAR', 'Työkalupalkki');
